...
const BUILDING_BLOCKS: BuildingBlock[] = [
  ...
  },
  {
    ...
    description: 'Internationella och nationella klassifikationssystem som möjliggör strukturerad informationsdelning mellan sektorer.',
  ...
  },
  {
    ...
    description: 'Skottlands nationella policy med SHANARRI:s 8 välbefinnandedimensioner. I Sverige tolkad genom Connected Children vid Linnéuniversitetet, med lokala variationer.',
...
const INITIATIVES: Initiative[] = [
  {
    ...
    howWeSupport: 'Prototypen visar hur en gemensam informationsprofil kan se ut i praktiken - med välbefinnandehjulet som gemensamt språk och semantisk mappning till alla berörda sektorers kodverk (ICF, BBIC, KSI, KVÅ Snomed CT).',
    icon: <Heart size={20} />,
    color: 'rose',
  },
  {
    ...
    howWeSupport: 'Bygger uteslutande på befintliga öppna standarder och demonstrerar hur semantisk mappning kan brygga sektorsgränser utan att skapa nya informationssilos.',
    icon: <Handshake size={20} />,
    color: 'blue',
  },
  {
    title: 'GIRFEC i Sverige: Connected Children & lokala variationer',
    description: 'Connected Children vid Linnéuniversitetet är den svenska tolkningen av Skottlands GIRFEC-policy. Lokala variationer inkluderar Kronobarnsmodellen (Region Kronoberg), Backa Barnet (Ystad) och Tillsammans för varje barn (Falun) - alla med GIRFEC som gemensam utgångspunkt.',
