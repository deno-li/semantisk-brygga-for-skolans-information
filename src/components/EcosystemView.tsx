...
const BUILDING_BLOCKS: BuildingBlock[] = [
  ...
  {
    id: 'who',
    name: 'ICF & GIRFEC/SHANARRI',
    organization: 'WHO / Skottland',
    description: 'Internationella ramverk för funktionsklassificering och barnets välbefinnande som ger vetenskaplig grund.',
    standards: ['ICF (Funktionstillstånd)', 'GIRFEC (Getting It Right)', 'SHANARRI (8 dimensioner)'],
...
const INITIATIVES: Initiative[] = [
  ...
  {
    title: 'Connected Children & Kronobarnsmodellen',
    description: 'Forskningsprogram vid Linnéuniversitetet som implementerar GIRFEC-ramverket i Sverige tillsammans med Region Kronoberg och flera kommuner.',
    howWeSupport: 'SHANARRI-hjulet i prototypen bygger direkt på GIRFEC/Connected Childrens vetenskapliga grund. Vi utvidgar med ICF-kodning för att möjliggöra tvärsektoriell uppföljning.',
