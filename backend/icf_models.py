...
class ICFCode(BaseModel):
    ...
    level: int = Field(
        ..., description="Hierarchy level (1=chapter, 2-7=subcategories)"
    )
...
class ICFQualifiedCode(BaseModel):
    ...
    qualifier_extent: Optional[QualifierExtent] = Field(
        None, description="Extent of problem"
    )
...
class ICFFunctionDescription(BaseModel):
    ...
    icf_subcodes: Optional[List[str]] = Field(
        default_factory=list, description="Additional detailed codes"
    )
    function_name: str = Field(..., description="Function name in Swedish")
    qualifier_extent: Optional[QualifierExtent] = Field(
        None, description="Extent qualifier"
    )
    ...
    documented_by_role: str = Field(
        ..., description="Role who documented (Lärare, Specialpedagog)"
    )
    ...
    related_interventions: List[str] = Field(
        default_factory=list, description="Related intervention IDs"
    )
...
class ICFEnvironmentalFactor(BaseModel):
    ...
    mitigation: Optional[List[dict]] = Field(
...
ICF_DATABASE = {
    ...
    "b1": ICFCode(
        code="b1",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Mentala funktioner",
        level=1,
    ),
    "b140": ICFCode(
        code="b140",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Uppmärksamhetsfunktioner",
        name_en="Attention functions",
        parent_code="b1",
        level=3,
    ...
    "b1400": ICFCode(
        code="b1400",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Funktioner för att vidmakthålla uppmärksamhet",
        name_en="Sustaining attention",
        parent_code="b140",
        level=4,
    ...
    "b1401": ICFCode(
        code="b1401",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Funktioner för att skifta uppmärksamhet",
        name_en="Shifting attention",
        parent_code="b140",
        level=4,
    ...
    "b1402": ICFCode(
        code="b1402",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Funktioner för delad uppmärksamhet",
        name_en="Dividing attention",
        parent_code="b140",
        level=4,
    ...
    "b1403": ICFCode(
        code="b1403",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Funktioner för gemensam uppmärksamhet",
        name_en="Sharing attention",
        parent_code="b140",
        level=4,
    ...
    "b152": ICFCode(
        code="b152",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Känslofunktioner",
        name_en="Emotional functions",
        parent_code="b1",
        level=3,
    ...
    "b134": ICFCode(
        code="b134",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Sömnfunktioner",
        name_en="Sleep functions",
        parent_code="b1",
        level=3,
    ),
    "b130": ICFCode(
        code="b130",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Energi och driftfunktioner",
        name_en="Energy and drive functions",
        parent_code="b1",
        level=3,
    ),
    "b1300": ICFCode(
    ...
    "b164": ICFCode(
        code="b164",
        component=ICFComponent.BODY_FUNCTIONS,
        name_sv="Högre kognitiva funktioner",
        name_en="Higher-level cognitive functions",
        parent_code="b1",
        level=3,
    ),
    "b280": ICFCode(
    ...
    "d1": ICFCode(
        code="d1",
        component=ICFComponent.ACTIVITIES_PARTICIPATION,
        name_sv="Lärande och att tillämpa kunskap",
        name_en="Learning and applying knowledge",
        level=1,
    ),
    "d110": ICFCode(
        code="d110",
    ...
    "d155": ICFCode(
        code="d155",
        component=ICFComponent.ACTIVITIES_PARTICIPATION,
        name_sv="Att förvärva färdigheter",
        name_en="Acquiring skills",
        parent_code="d1",
        level=3,
    ),
    "d160": ICFCode(
    ...
    "d175": ICFCode(
        code="d175",
        component=ICFComponent.ACTIVITIES_PARTICIPATION,
        name_sv="Att lösa problem",
        name_en="Solving problems",
        parent_code="d1",
        level=3,
    ),
    "d177": ICFCode(
        code="d177",
        component=ICFComponent.ACTIVITIES_PARTICIPATION,
        name_sv="Att fatta beslut",
        name_en="Making decisions",
        parent_code="d1",
        level=3,
    ),
    ...
    "d710": ICFCode(
        ...
        name_en="Basic interpersonal interactions",
        parent_code="d7",
        level=3,
    ),
    "d7100": ICFCode(
        ...
        name_en="Respect and warmth in relationships",
        parent_code="d710",
        level=4,
    ),
    "d7107": ICFCode(
        ...
        name_en="Tolerance in relationships",
        parent_code="d710",
        level=4,
    ),
    ...
    "d920": ICFCode(
        code="d920",
        component=ICFComponent.ACTIVITIES_PARTICIPATION,
        name_sv="Rekreation och fritid",
        name_en="Recreation and leisure",
        parent_code="d9",
        level=3,
    ),
    ...
    "e2": ICFCode(
        code="e2",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Naturliga omgivningsfaktorer",
        name_en="Natural environment",
        level=1,
    ),
    "e250": ICFCode(
        code="e250",
    ...
    "e2501": ICFCode(
        code="e2501",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Ljudkvalitet",
        name_en="Sound quality",
        parent_code="e250",
        level=4,
    ),
    ...
    "e3": ICFCode(
        code="e3",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Stöd och relationer",
        name_en="Support and relationships",
        level=1,
    ),
    "e310": ICFCode(
        code="e310",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Närmaste familjen",
        name_en="Immediate family",
        parent_code="e3",
        level=3,
    ),
    "e330": ICFCode(
        code="e330",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Personer i auktoritetsställning",
        name_en="People in positions of authority",
        parent_code="e3",
        level=3,
    ),
    "e355": ICFCode(
    ...
    "e165": ICFCode(
        code="e165",
        component=ICFComponent.ENVIRONMENTAL_FACTORS,
        name_sv="Attityder i omgivningen",
        name_en="Individual attitudes",
        parent_code="e1",
        level=3,
    ),
}
