    ...
    <div className="min-h-screen bg-[#F3F3F3] text-[#1F1F1F] font-sans flex flex-col">
      ...
      <footer className="bg-[#1F1F1F] text-white py-12 mt-auto">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
           <div>
             <h4 className="font-bold mb-4 text-lg">En prototyp för barnets & individens bästa och delaktighet</h4>
             <p className="text-gray-400 leading-relaxed">
               Utvecklad för att demonstrera ett kompletterande perspektiv för utvecklingsinitiativet "Barnets rätt till information" genom semantisk brygga, ICF & KSI, som mappar skolans information till Socialstyrelsens informationsstruktur och mängder. 
               Syftet är att visa hur informationsdelning och samverkan mellan skola, vård och omsorg kan visualiseras för hälsofrämjande och förebyggande arbete, samt samordnade insatser vid behov.
             </p>
           </div>
